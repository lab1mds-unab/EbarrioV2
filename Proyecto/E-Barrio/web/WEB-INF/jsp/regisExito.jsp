<%-- 
    Document   : RegisExito
    Created on : 08-01-2019, 14:18:40
...
<html>
    <head>
        <meta http-equiv="Refresh" content="4;url=login.htm">
        <title>E-Barrio | Registro Exitoso</title>
        ...
        <script type="text/javascript">
            function redireccionar() {
                window.locationf = "E-Barrio/login.htm";
            }
    ...
    <body>
        ...
        <h3 align="center">¡ Se ha REGISTRADO exitósamente ! En breve será redireccionado al Login</h3>
        <p>- Debe ingresar con el <b>EMAIL</b> y <b>PASSWORD</b> ingresados -</p>
        <br/><br/><br/>

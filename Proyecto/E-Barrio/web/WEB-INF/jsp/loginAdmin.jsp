<%-- 
    Document   : loginAdmin
    Created on : 07-01-2019, 16:03:03
    Author     : Francisco Sáez Guerra
--%>

<%@page import="modelo.ConectarAdmin"%>
...
<html>
    <head>
        ...
        <title>E-Barrio | Ingreso Administrador</title>
    ...
    <body>
        ...
        <div class="container" align="center">
            <div class="panel-heading">
                <h1 style="color:black">Ingreso Administrador</h1>
            </div>
            <div class="row" id="pwd-container">
                <div class="col-md-4 text-center" align="center">
                    <section class="login-form">
                        <form method="POST" action="loginAdmin.htm" role="login">
                            <img src="img/adminHeader.png" class="responsive-img" alt="" width="300" height="150"  />
                        ...
                        <%
                            ConectarAdmin conn = new ConectarAdmin();
                            if (request.getParameter("btnIngresar") != null) {
                                ...
                                switch (conn.loguear(usu, pass)) {
                                    case 1:
                                        ...
                                        response.sendRedirect("inicioAdmin.htm");
                                        break;

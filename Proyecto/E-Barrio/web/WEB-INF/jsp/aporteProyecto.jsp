<%-- 
    Document   : aporteProyecto
    Created on : 17-01-2019, 12:18:14
...
<html>
    <head>
        ...
        <title>E-Barrio | Aportar a Proyecto</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <h3 style="text-align: center;">Aportes para proyectos Aprobados</h3>
                <hr>
                <p style="text-align: center;">Se pueden realizar aportes monetarios, de materiales y de mano de obra.</p>
                <p style="text-align: center;"><strong>Todos los aportes deben ser ingresados en su equivalente en dinero.</strong></p>

            </div>
        </div>
        
        <!-- VISTA POR MODIFICAR - CAMBIAR EL <FORM> POR EL <FORM:FORM> Y APLICAR CONOCIMIENTO EXPLICADO EN EL INFORME DE ESTE PROYECTO O TOMAR COMO REFERENCIA LA VISTA DE ALGUN 
        FORMULARIO COMO crearProyecto.htm !
        -->
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <%
                            usu = sesion.getAttribute("user").toString();
                        %>
                        <input path="${user}" value="${user}" class="tooltipped" data-position="bottom" data-delay="50" type="text" readonly="true"/>
                    </div>
                    <div class="input-field col s6">
                        <input type="text" list="proyectos1" name="proyectos" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Seleccionar proyecto">
                        <datalist id="proyectos1">
                            <c:forEach items="${proyectoAporte}" var="datosAporte">
                                <option value="<c:out value="${datosAporte.nombre}"/>"><c:out value="${datosAporte.nombre}"/></option>
                            </c:forEach>
                        </datalist>
                        <label for="proyectos"><strong>Seleccionar proyecto</strong></label>
                    </div>
                    <div class="input-field col s6">
                        <input type="number" name="dinero" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Ingresar cantidad de dinero a aportar">
                        <label for="dinero"><strong>Aporte en dinero</strong></label>
                    </div>
                    <div class="input-field col s6">
                        <input type="number" name="materiales" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Ingresar cantidad en dinero de materiales a aportar">
                        <label for="proyectos"><strong>Aporte en materiales</strong></label>
                    </div>
                    <div class="input-field col s6">
                        <input type="number" name="trabajo" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Ingresar cantidad en dinero de horas hombre a aportar">
                        <label for="proyectos"><strong>Aporte en mano de obra</strong></label>
                    </div>
                    <div>
                        <input class="btn waves-yellow red" type="button" value="Aportar a proyecto">&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
            </form>
        </div>
